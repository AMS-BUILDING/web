...
export default function CountRequestService() {
    ...
    const search = async () => {
        let path = '/manager-service/dashboard/yearlyCountServiceRequest';
    ...
    const bars = {
        ...
        datasets: [
            {
                label: 'Thống kê theo năm tổng dịch vụ cư dân sử dụng',
                data: data,
